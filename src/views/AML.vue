    ...
    <a-modal
      ...
      <div class="modal-container">
        ...
        <div v-if="AMLTab === 'upload'">
          <a-upload-dragger name="file" :multiple="true" action="https://www.mocky.io/v2/5cc8019d300000980a055e76" @change="uploadHandleChange">
